...
import { TweetSearchAllV2Paginator, TweetSearchRecentV2Paginator, TweetUserMentionTimelineV2Paginator, TweetUserTimelineV2Paginator, TweetV2UserLikedTweetsPaginator } from '../paginators';
...
export default class TwitterApiv2ReadOnly extends TwitterApiSubClient {
     ...
     */
    tweetRetweetedBy(tweetId: string, options?: Partial<UsersV2Params>): Promise<TweetV2RetweetedByResult>;
    /**
     * Allows you to get information about who has Liked a Tweet.
     * https://developer.twitter.com/en/docs/twitter-api/tweets/likes/api-reference/get-tweets-id-liking_users
     */
    tweetLikedBy(tweetId: string, options?: Partial<UsersV2Params>): Promise<TweetV2LikedByResult>;
    /**
