...
class ClientRequestMaker {
    ...
    getHttpRequestArgs({ url, method, query: rawQuery = {}, body: rawBody = {}, headers, forceBodyMode, enableAuth, params, }) {
        ...
        if (params) {
            url = request_param_helper_1.default.applyRequestParametersToUrl(url, params);
        }
        ...
        url = request_param_helper_1.default.mergeUrlQueryIntoObject(url, query);
        ...
        url += request_param_helper_1.default.constructGetParams(query);
        return {
            rawUrl,
            url,
            method,
